...
public class DataSeeder implements CommandLineRunner {
    ...
    private void seedCategoriesAndProducts() {
        // Categories
        Category catIphone = Category.builder().name("iPhone").slug("iphone").build();
        Category catSamsung = Category.builder().name("Samsung").slug("samsung").build();
        Category catXiaomi = Category.builder().name("Xiaomi").slug("xiaomi").build();
        Category catOppo = Category.builder().name("OPPO").slug("oppo").build();
        Category catRealme = Category.builder().name("Realme").slug("realme").build();
